...
public class CloudSourceConfig extends HoodieConfig {
  ...
  private static final String CLOUD_SOURCE_PREFIX = "source.cloud.";
  private static final String STREAMER_CLOUD_SOURCE_PREFIX = STREAMER_CONFIG_PREFIX + CLOUD_SOURCE_PREFIX;
  private static final String DELTA_STREAMER_CLOUD_SOURCE_PREFIX = DELTA_STREAMER_CONFIG_PREFIX + CLOUD_SOURCE_PREFIX;

  public static final ConfigProperty<Integer> BATCH_SIZE_CONF = ConfigProperty
      .key(STREAMER_CLOUD_SOURCE_PREFIX + "meta.batch.size")
      /*
       ...
       */
      .defaultValue(10)
      .withAlternatives(DELTA_STREAMER_CLOUD_SOURCE_PREFIX + "meta.batch.size")
      .markAdvanced()
  ...
  public static final ConfigProperty<Boolean> ACK_MESSAGES = ConfigProperty
      .key(STREAMER_CLOUD_SOURCE_PREFIX + "meta.ack")
      .defaultValue(true)
      .withAlternatives(DELTA_STREAMER_CLOUD_SOURCE_PREFIX + "meta.ack")
      .markAdvanced()
  ...
  public static final ConfigProperty<String> SELECT_RELATIVE_PATH_PREFIX = ConfigProperty
      .key(STREAMER_CLOUD_SOURCE_PREFIX + "data.select.relpath.prefix")
      .noDefaultValue()
      .withAlternatives(DELTA_STREAMER_CLOUD_SOURCE_PREFIX + "data.select.relpath.prefix")
      .markAdvanced()
  ...
  public static final ConfigProperty<String> SELECT_RELATIVE_PATH_REGEX = ConfigProperty
      .key(STREAMER_CLOUD_SOURCE_PREFIX + "data.select.relative.path.regex")
      .noDefaultValue()
      .withAlternatives(DELTA_STREAMER_CLOUD_SOURCE_PREFIX + "data.select.path.regex")
      .markAdvanced()
      .sinceVersion("1.0.0")
  ...
  public static final ConfigProperty<String> IGNORE_RELATIVE_PATH_PREFIX = ConfigProperty
      .key(STREAMER_CLOUD_SOURCE_PREFIX + "data.ignore.relpath.prefix")
      .noDefaultValue()
      .withAlternatives(DELTA_STREAMER_CLOUD_SOURCE_PREFIX + "data.ignore.relpath.prefix")
      .markAdvanced()
  ...
  public static final ConfigProperty<String> IGNORE_RELATIVE_PATH_SUBSTR = ConfigProperty
      .key(STREAMER_CLOUD_SOURCE_PREFIX + "data.ignore.relpath.substring")
      .noDefaultValue()
      .withAlternatives(DELTA_STREAMER_CLOUD_SOURCE_PREFIX + "data.ignore.relpath.substring")
      .markAdvanced()
  ...
  public static final ConfigProperty<String> SPARK_DATASOURCE_OPTIONS = ConfigProperty
      .key(STREAMER_CLOUD_SOURCE_PREFIX + "data.datasource.options")
      .noDefaultValue()
      .withAlternatives(DELTA_STREAMER_CLOUD_SOURCE_PREFIX + "data.datasource.options")
      .markAdvanced()
  ...
  public static final ConfigProperty<String> CLOUD_DATAFILE_EXTENSION = ConfigProperty
      .key(STREAMER_CLOUD_SOURCE_PREFIX + "data.select.file.extension")
      .noDefaultValue()
      .withAlternatives(DELTA_STREAMER_CLOUD_SOURCE_PREFIX + "data.select.file.extension")
      .markAdvanced()
  ...
  public static final ConfigProperty<String> DATAFILE_FORMAT = ConfigProperty
      .key(STREAMER_CLOUD_SOURCE_PREFIX + "data.datafile.format")
      .defaultValue(HoodieIncrSourceConfig.SOURCE_FILE_FORMAT.defaultValue())
      .withAlternatives(DELTA_STREAMER_CLOUD_SOURCE_PREFIX + "data.datafile.format")
      .markAdvanced()
  ...
  public static final ConfigProperty<String> PATH_BASED_PARTITION_FIELDS = ConfigProperty
      .key(STREAMER_CLOUD_SOURCE_PREFIX + "data.partition.fields.from.path")
      .noDefaultValue()
      .withAlternatives(DELTA_STREAMER_CLOUD_SOURCE_PREFIX + "data.partition.fields.from.path")
      .markAdvanced()
      .sinceVersion("0.14.0")
  ...
  public static final ConfigProperty<Boolean> SPARK_DATASOURCE_READER_COMMA_SEPARATED_PATH_FORMAT = ConfigProperty
      .key(STREAMER_CLOUD_SOURCE_PREFIX + "data.reader.comma.separated.path.format")
      .defaultValue(false)
      .markAdvanced()
      .sinceVersion("0.14.1")
  ...
  public static final ConfigProperty<String> SOURCE_MAX_BYTES_PER_PARTITION = ConfigProperty
      .key(STREAMER_CLOUD_SOURCE_PREFIX + "data.partition.max.size")
      .noDefaultValue()
      .markAdvanced()
      .sinceVersion("0.14.1")
  ...
  public static final ConfigProperty<Boolean> SPARK_DATASOURCE_READER_COALESCE_ALIAS_COLUMNS = ConfigProperty
      .key(STREAMER_CLOUD_SOURCE_PREFIX + "data.reader.coalesce.aliases")
      .defaultValue(false)
      .markAdvanced()
      .sinceVersion("0.15.0")
  ...
  public static final ConfigProperty<Boolean> INCLUDE_SOURCE_PATH_FIELD = ConfigProperty
      .key(STREAMER_CLOUD_SOURCE_PREFIX + "data.include.source.path.field")
      .defaultValue(false)
      .markAdvanced()
