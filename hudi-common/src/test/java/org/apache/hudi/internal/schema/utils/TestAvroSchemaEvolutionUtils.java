...
public class TestAvroSchemaEvolutionUtils {
  ...
  public void testReconcileSchemaTimestampPrecisionEvolution() {
    ...
    Schema tableSchemaMicros = create("trip",
    ...
    Schema incomingSchemaMillis = create("trip",
        new Schema.Field("id", Schema.create(Schema.Type.STRING), null, null),
    ...
    Schema tableBareLong = create("trip",
        new Schema.Field("id", Schema.create(Schema.Type.STRING), null, null),
    ...
    Schema incomingLocalMicros = create("trip",
        new Schema.Field("id", Schema.create(Schema.Type.STRING), null, null),
        new Schema.Field("ts", LogicalTypes.localTimestampMicros().addToSchema(Schema.create(Schema.Type.LONG)), null, null));
  ...
  public void testEvolutionSchemaFromNewAvroSchema() {
    ...
    InternalSchema result = AvroSchemaEvolutionUtils.reconcileSchema(evolvedAvroSchema, oldSchema, false, false);
  ...
  public void testReconcileSchema() {
    ...
    Schema simpleReconcileSchema = AvroInternalSchemaConverter.convert(AvroSchemaEvolutionUtils
        .reconcileSchema(incomingSchema, AvroInternalSchemaConverter.convert(schema), false, false), "schemaNameFallback");
  ...
  public void testNotEvolveSchemaIfReconciledSchemaUnchanged() {
    ...
    InternalSchema evolvedSchema = AvroSchemaEvolutionUtils.reconcileSchema(incomingSchema, oldInternalSchema, false, false);
