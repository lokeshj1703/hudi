...
public class SparkHoodieBackedTableMetadataWriter extends HoodieBackedTableMetadataWriter<JavaRDD<HoodieRecord>> {
  ...
  @VisibleForTesting
  protected SparkHoodieBackedTableMetadataWriter(Configuration hadoopConf,
                                       HoodieWriteConfig writeConfig,
                                       HoodieFailedWritesCleaningPolicy failedWritesCleaningPolicy,
  ...
  protected void initRegistry() {
    if (metadataWriteConfig.isMetricsOn()) {
      ...
      this.metrics = Option.of(new HoodieMetadataMetrics(metadataWriteConfig.getMetricsConfig(), dataWriteConfig.getMetadataConfig().shouldEnableDetailedMetrics()));
    } else {
