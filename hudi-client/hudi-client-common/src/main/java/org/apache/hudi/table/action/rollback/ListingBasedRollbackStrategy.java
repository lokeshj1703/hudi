    ...
    try {
      ...
      return context.flatMap(partitionPaths, partitionPath -> {
        ...
        if (HoodieTableType.COPY_ON_WRITE == tableType) {
          hoodieRollbackRequests.addAll(RollbackUtils.getHoodieRollbackRequests(partitionPath, filesToDelete.get()));
          ...
          switch (action) {
            ...
            case HoodieTimeline.COMPACTION_ACTION:
              ...
              if (!isRestore) {
                ...
                hoodieRollbackRequests.addAll(RollbackUtils.getHoodieRollbackRequests(partitionPath,
                ...
                RollbackUtils.getRollbackRequestsForCompactionDuringRestore(instantToRollback, partitionPath, metaClient, hoodieRollbackRequests, filesToDelete, baseFileExtension);
              }
              break;
            case HoodieTimeline.DELTA_COMMIT_ACTION:
            case HoodieTimeline.LOG_COMPACTION_ACTION:
              RollbackUtils.getRollbackRequestsForDeltaCommit(instantToRollback, partitionPath, hoodieRollbackRequests, filesToDelete, metaClient, commitMetadataOptional, table);
              break;
            default:
