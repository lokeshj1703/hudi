 ...
 */
@NotThreadSafe
public class HoodieSortedRowMergeHandle<T, I, K, O> extends HoodieRowMergeHandle<T, I, K, O> {

  private final Queue<String> newRecordKeysSorted = new PriorityQueue<>();

  public HoodieSortedRowMergeHandle(HoodieWriteConfig config, String instantTime, HoodieTable<T, I, K, O> hoodieTable,
